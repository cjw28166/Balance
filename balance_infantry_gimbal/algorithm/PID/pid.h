...
extern fp32 YAW_cascade_PID_calc(cascade_pid_t *c_pid, fp32 o_ref, fp32 i_ref, fp32 o_set);
extern fp32 PITCH_cascade_PID_calc(cascade_pid_t *c_pid, fp32 o_ref, fp32 i_ref, fp32 o_set);
extern fp32 ROTOR_cascade_PID_calc(cascade_pid_t *c_pid, fp32 o_ref, fp32 i_ref, fp32 o_set);
/**
  * @brief          pid out clear
  * @param[out]     pid: PID struct data point
  * @retval         none
