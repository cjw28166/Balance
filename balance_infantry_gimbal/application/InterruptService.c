...
//			}
        ...
        case ROTOR_MOTOR_ID:
        {
            ...
            MotorProcess(rx_header.StdId, hcan, rx_data);	
						if(RotorMotorMeasure.ecd-RotorMotorMeasure.last_ecd>6000)	
								rotor_flag--;
						if(RotorMotorMeasure.last_ecd-RotorMotorMeasure.ecd>6000)	
								rotor_flag++;	
						
						//printf("%d,%d\n",RotorMotorMeasure.ecd,RotorMotorMeasure.last_ecd);
            break;
        }
...
void TimerTaskLoop100Hz(void)
{
	...
	//if(Aimbot.PitchRelativeAngle!=0)
			//			printf("%lf,%lf\r\n",Gimbal.Imu.PitchAngle,Aimbot.PitchRelativeAngle);
		//printf("%f,%f\n",Gimbal.MotorMeasure.ShootMotor.RotorMotorEcd/10000.0+rotor_flag*0.8192,ecd_count);
//		if(Gimbal.FireMode==GM_FIRE_COOLING)
//				printf("%f,%f,1\n",Gimbal.Pid.Rotor.s_set,Gimbal.Pid.Rotor.s_fdb);
//		else
//				printf("%f,%f,0\n",Gimbal.Pid.Rotor.s_set,Gimbal.Pid.Rotor.s_fdb);
//		printf("%f,%f\n",Gimbal.Pid.Rotor.v_set,Gimbal.Pid.Rotor.v_fdb);
